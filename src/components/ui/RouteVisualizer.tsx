    ...
    <div className="w-full bg-[#060709] border border-white/10 p-5 overflow-hidden flex flex-col gap-4 text-xs font-mono select-none">
      ...
      <div className="flex items-center justify-between border-b border-white/10 pb-3">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`px-3 py-1 text-[10px] tracking-widest uppercase transition-all flex items-center gap-1.5 border cursor-pointer ${
              optimized
      ...
      <div className="grid grid-cols-3 gap-2 pt-1">
        <div className="bg-white/5 border border-white/10 p-2.5 flex flex-col">
          <span className="text-[9px] text-zinc-500 uppercase tracking-wider">TOTAL TRANSIT</span>
          <span className="text-sm font-bold text-white font-sans mt-0.5">
            {optimized ? "41.8 km" : "68.4 km"}
          </span>
          <span className="text-[9px] text-zinc-300 font-sans mt-0.5 font-medium">
            {optimized ? "↓ 38.8% reduction" : "Standard baseline"}
          </span>
        </div>

        <div className="bg-white/5 border border-white/10 p-2.5 flex flex-col">
          <span className="text-[9px] text-zinc-500 uppercase tracking-wider">FUEL BURN</span>
          <span className="text-sm font-bold text-white font-sans mt-0.5">
            {optimized ? "5.4 Liters" : "8.9 Liters"}
          </span>
          <span className="text-[9px] text-zinc-300 font-sans mt-0.5 font-medium">
            {optimized ? "↓ 3.5L Saved" : "High burn rate"}
          </span>
        </div>

        <div className="bg-white/5 border border-white/10 p-2.5 flex flex-col">
          <span className="text-[9px] text-zinc-500 uppercase tracking-wider">DISPATCH TIME</span>
          <span className="text-sm font-bold text-white font-sans mt-0.5">
            {optimized ? "46 Mins" : "82 Mins"}
          </span>
          <span className="text-[9px] text-white font-sans mt-0.5 flex items-center gap-1 font-semibold">
